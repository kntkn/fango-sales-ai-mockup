...
export const inquiries: Inquiry[] = [
  { id: 'inq1', customerName: '田中太郎', email: 'tanaka@example.com', phone: '090-1234-5678', timestamp: mins(3) },
  { id: 'inq2', customerName: '木村拓哉', email: 'kimura@example.com', phone: '090-2345-6789', timestamp: mins(45) },
  { id: 'inq3', customerName: '佐藤花子', email: 'sato@example.com', phone: '090-3456-7890', timestamp: mins(90) },
  { id: 'inq4', customerName: '中村翔太', email: 'nakamura@example.com', phone: '090-4567-8901', timestamp: mins(120) },
  { id: 'inq5', customerName: '高橋健一', email: 'takahashi@example.com', phone: '090-5678-9012', timestamp: mins(180) },
  { id: 'inq6', customerName: '伊藤真紀', email: 'ito@example.com', phone: '090-6789-0123', timestamp: mins(240) },
];
